...
<div class="preview-section-chaty">
    <div class="preview" id="admin-preview">
        <h2><span class="header-tooltip"><span class="header-tooltip-text">Please make all your live tests in <a href="https://www.computerworld.com/article/3356840/how-to-go-incognito-in-chrome-firefox-safari-and-edge.html" target="_blank">incognito mode</a>. Some of the features like call to action, attention effect, and trigger will appear for your website visitors just once until they engage with the chat widget, so to emulate it you'll need to use incognito mode</span> <span class="dashicons dashicons-editor-help"></span></span><?php esc_attr_e('Preview', CHT_OPT); ?>:</h2>
        ...
        <div class="page">
            ...
            <div class="page-body">
                <?php
                $cht_position = get_option("cht_position".$this->widget_index);
                ...
                $widget_icon = get_option('widget_icon'.$this->widget_index);
                ?>
...
<section class="section one chaty-setting-form" id="<?php esc_attr_e($pro_id) ?>" style="padding-bottom: 0;" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="channels-icons" id="channel-list">
        <?php if ($this->socials) :
            foreach ($this->socials as $key => $social) :
                ...
                endforeach; ?>
                <div class="icon icon-sm chat-channel-<?php echo esc_attr($social['slug']); ?> <?php echo esc_attr($active_class) ?>" data-social="<?php echo esc_attr($social['slug']); ?>" data-title="<?php esc_attr_e($social['title']); ?>">
                    <span class="icon-box">
    ...
    <?php if (!$this->is_pro()) : ?>
        <div class="popover" style="">
            <a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">
                ...
                <strong><?php esc_attr_e('Activate your license key', CHT_OPT); ?></strong>
            </a>
        </div>
    <?php endif; ?>
    ...
    <div class="chaty-sticky-buttons">
        ...
        <a href="#" class="preview-help-btn"><?php esc_attr_e('Preview', CHT_OPT); ?></a>
