                    ...
                    <div class="color-picker-box">
                        <div class="color-picker-radio">
                            <label style="background-color: #A886CD">
                                <input type="radio" name="cht_color" value="#A886CD" title="Purple" <?php checked($color, '#A886CD') ?> >
                                <span></span>
                            </label>

                            <label style="background-color: #86CD91">
                                <input type="radio" name="cht_color" value="#86CD91" title="Green" <?php checked($color, '#86CD91') ?>  />
                                <span></span>
                            </label>

                            <label style="background-color: #4F6ACA">
                                <input type="radio" name="cht_color" value="#4F6ACA" title="Blue" <?php checked($color, '#4F6ACA') ?> />
                                <span></span>
                            </label>

                            <label style="background-color: #FF6060">
                                <input type="radio" name="cht_color" value="#FF6060" title="Red" <?php checked($color, '#FF6060') ?>  >
                                <span></span>
                            </label>

                            <label style="background-color: #000">
                                <input type="radio" name="cht_color" value="#000" title="Black" <?php checked($color, '#000') ?>  >
                                <span></span>
                            </label>

                            <label style="background-color: #EEF075">
                                <input type="radio" name="cht_color" value="#EEF075" title="Yellow" <?php checked($color, '#EEF075') ?>  >
                                <span></span>
                            </label>

                            <label style="background-color: #FF95EE">
                                <input type="radio" name="cht_color" value="#FF95EE" title="Pink" <?php checked($color, '#FF95EE') ?> >
                                <span></span>
                            </label>
                        </div>
                        ...
                        <div class="color-picker-custom">
                            ...
                            ?>
                            <label class="color-checkbox custom-color-picker"  for="cht_color_custom">
                                <input type="radio" id="cht_color_custom" name="cht_color" title="Custom" class="sr-only checkbox-color color-field" value="<?php echo esc_attr($color) ?>" <?php checked($selected, 1) ?> />
                                <span class="color-box"><span class="color-box-area">Custom color</span></span>
                            </label>
                            <input type="hidden" name="cht_custom_color" id="cht_custom_color" value="<?php esc_attr_e($color); ?>" />
                            <?php /*if ($this->is_pro()) : */?><!--
                                <div>
...
/*                                    if(!empty($color)) {
                                    ...
                                    */?>
                                    <input type="input" name="cht_custom_color" id="cht_custom_color" placeholder="HEX code: #ffffff" value="<?php /*esc_attr_e($color); */?>" />
                ...
                <?php if ($this->is_pro()) : ?>
                    <label class="custom-control custom-radio" for="positionCustom">
                        ...
                        <span class="custom-control-label">
                            <?php esc_attr_e('Custom Position', CHT_OPT); ?>
                        </span>
                    </label>
                <?php else: ?>
        ...
        <div class="form-horizontal__item flex-center">
            <label class="form-horizontal__item-label"><span class="icon label-tooltip" data-title="Increase your click-rate by displaying a pending messages icon near your Chaty widget to let your visitors know that you're waiting for them to contact you."><span class="dashicons dashicons-editor-help"></span></span> <?php esc_attr_e('Pending messages', CHT_OPT);?>:</label>
            ...
            <label class="widget-icon__wrap <?php esc_attr_e($pro_class)  ?>">
                ...
                <div class="custom-control custom-radio upgrade-upload-btn">
                    ...
                    <label class="custom-control custom-radio" id="image-upload-content">
                        ...
                        <?php if (!$this->is_pro()): ?>
                        <span class="custom-control-label"></span>
                        <a class="upgrade-link" target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>"><?php esc_attr_e('Activate your license key', CHT_OPT); ?></a>
                </div>
                <?php else: ?>
            </label>
            <?php endif; ?>
        ...
        <div>
            ...
            <select name="cht_widget_font" class="form-fonts">
                ...
                foreach ($fonts as $key => $value):
                    ...
                    ?>
                    <option data-group="<?php echo $value; ?>" value="<?php echo $key_value; ?>" data-type="<?php echo esc_attr($value); ?>" <?php selected($font, $key_value); ?>><?php echo $key; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
    ...
    <div class="form-horizontal__item flex-center">
        ...
        <div>
            <label class="switch">
                ...
                <span class="switch__styled"></span>
                <span class="switch__label"><?php esc_attr_e('On', CHT_OPT);?></span>
                <?php if (!$this->is_pro()): ?><a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_OPT); ?>)</a><?php endif ?>
            </label>
        </div>
    </div>
