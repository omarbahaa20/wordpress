...
class Chaty_pro_review_box {
    ...
    public function __construct() {
        ...
        add_action("wp_ajax_".$this->plugin_slug."_review_box", array($this, "chaty_review_box"));

        add_action('admin_notices', array($this, 'admin_notices'));
    }

    public function chaty_review_box() {
    ...
    public function admin_notices() {
        if (current_user_can('manage_options')) {
            ...
            <style>
                ...
                .notice.notice-info.chaty-pro-notice {
                    display: block !important;
                    position: relative;
                    padding: 1px 30px 1px 12px;
                }

                .notice.notice-info.chaty-pro-notice ul li {
                    margin: 0;
                }

                .notice.notice-info.chaty-pro-notice ul li a {
                    color: #0073aa;
                    font-size: 14px;
            ...
            <div
                class="notice notice-info chaty-pro-notice <?php echo $this->plugin_slug ?>-premio-review-box <?php echo $this->plugin_slug ?>-premio-review-box">
                <p>
                    Hi there, it seems like <b><?php echo $this->plugin_name ?></b> is bringing you some value, and
                    that's pretty awesome! Can you please show us some love and rate <?php echo $this->plugin_name ?> on
                    WordPress? It'll only take 2 minutes of your time, and will really help us spread the word
                    - <b>Gal Dubinski</b>, Co-founder <img width="30px"
                                                           src="<?php echo esc_url(CHT_PLUGIN_URL . "admin/assets/images/premio-owner.png") ?>"/>
                    <a href="javascript:;"
                       class="dismiss-btn <?php echo $this->plugin_slug ?>-premio-review-dismiss-btn"><span
                            class="dashicons dashicons-no-alt"></span></a>
                </p>

                <div class="clear clearfix"></div>
                <ul>
                    <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-hide-btn"
                           href="https://wordpress.org/support/plugin/chaty/reviews/?filter=5" target="_blank">I'd love
                            to help :)</a></li>
                    <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-future-btn" href="javascript:;">Not
                            this time</a></li>
                    <li><a class="<?php echo $this->plugin_slug ?>-premio-review-box-hide-btn" href="javascript:;">I've
                            already rated you</a></li>
                </ul>
            </div>
            <div class="<?php echo $this->plugin_slug ?>-review-box-popup">
                <div class="<?php echo $this->plugin_slug ?>-review-box-popup-content">
                    <button class="<?php echo $this->plugin_slug ?>-close-review-box-popup"><span
                            class="dashicons dashicons-no-alt"></span></button>
                    <div class="<?php echo $this->plugin_slug ?>-review-box-title">Would you like us to remind you about
                        this later?
                    </div>
...
$Chaty_pro_review_box = new Chaty_pro_review_box();