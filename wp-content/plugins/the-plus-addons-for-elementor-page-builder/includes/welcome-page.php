		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">OCT 22,2021 <span class="changelog-version">Lite Version 5.0.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Scan widget fix in Lightspeed server','tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Age Gate JS update for overflow issue in body','tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Bug fix and improvements','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">OCT 22,2021 <span class="changelog-version">Pro Version 5.0.4</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : WP Filters','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : WP Search Bar','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Syntax Highlighter','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Product Listing : Custom Loop Template','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Social Review : Language option in Google Review','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
