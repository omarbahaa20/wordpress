...
Contributors: recorp
Tags: export html, page to html, static, html, css, wp page, page, wp
Requires at least: 4
Tested up to: 5.4
Requires PHP: 5.4
Stable tag: trunk
...
Export Wordpress pages to static html and css in just one click. 
...
1. Download the different-menus-in-different-pages.zip file to your computer.
2. Unzip the file.
3. Upload the `different-menus-in-different-pages` directory to your `/wp-content/plugins/` directory.
...
== Changelog ==
= 1.0.4 - 6 June 2021 =
* Fixed Homepage option selecting issue.
* Added skip img src url option in settings panel.
