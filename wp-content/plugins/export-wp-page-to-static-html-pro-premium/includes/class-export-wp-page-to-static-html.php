...
class Export_Wp_Page_To_Static_Html {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-export-wp-page-to-static-html-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Export_Wp_Page_To_Static_Html_Admin( $this->get_plugin_name(), $this->get_version() );
