    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'no',
				'selectors' => [
					'{{WRAPPER}} .plus-navigation-wrap .plus-navigation-inner .navbar-nav>li.menu-item:hover a:before' => 'content: "";',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .plus-navigation-wrap .plus-navigation-inner .navbar-nav>li.menu-item:hover a:before' => 'border-left: {{SIZE}}{{UNIT}} solid transparent;border-right: {{SIZE}}{{UNIT}} solid transparent;border-bottom: {{SIZE}}{{UNIT}} solid {{mm_triangle_shape_color.VALUE}};',
