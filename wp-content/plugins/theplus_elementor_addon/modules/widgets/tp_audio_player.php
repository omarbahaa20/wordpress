...
class ThePlus_Audio_Player extends Widget_Base {
	...
	protected function render() {
		...
		$s_volume = (isset($settings['s_volume']['size'])) ? $settings['s_volume']['size'] : 80;
			...
			$audio_player = '<div class="tp-audio-player-wrapper '.esc_attr($uid_widget).' '.esc_attr($ap_style).' '.$animated_class.'" '.$animation_attr.' data-id="'.esc_attr($uid_widget).'" data-style="'.esc_attr($ap_style).'" data-apvolume="'.esc_attr($s_volume).'">';
			if($ap_style=='style-1'){
