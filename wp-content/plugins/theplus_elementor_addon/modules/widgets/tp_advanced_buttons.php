	...
	protected function render_text() {			
		...
		if(!empty($ab_button_type) && $ab_button_type=='cta'){		
			...
			if($cta_button_style=='tp_cta_st_14'){
				...
				if($detect->isTablet() && (!empty($settings['st14_button_width_tablet']) ? $settings['st14_button_width_tablet'] : $settings['st14_button_width'])){			
					$st14width = $settings['st14_button_width_tablet'];
				}else if($detect->isMobile() && (!empty($settings['st14_button_width_mobile']) ? $settings['st14_button_width_mobile'] : $settings['st14_button_width'])){	
					$st14width = $settings['st14_button_width_mobile'];
				}else{
					$st14width = $settings['st14_button_width'];
				}
