...
class ThePlus_Social_Reviews extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tp-social-reviews .tp-SR-time',
				'condition'   => [
					'RType' => 'review',
				],
			]
		...
		$this->add_group_control(
			...
			[
				'name' => 'UnTitleTypo',
				'label' => esc_html__( 'Title Text Typography', 'theplus' ),
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .tp-SR-title',
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
				],
		...
		$this->add_control(
			'UnTitleNCr',
			[
				'label' => esc_html__( 'Title Text Color', 'theplus' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .grid-item .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .grid-item:hover .tp-SR-title' => 'color: {{VALUE}}',	
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Text Typography', 'theplus' ),
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .facebook .tp-SR-title',
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .grid-item.facebook .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .facebook:hover .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Text Typography', 'theplus' ),
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .google .tp-SR-title',
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .google .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .google:hover .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Text Typography', 'theplus' ),
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .custom .tp-SR-title',
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .custom .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .tp-social-reviews .social-reviews-style-3 .custom:hover .tp-SR-title' => 'color: {{VALUE}}',					
				],
				'condition'   => [
					'RType' => 'review',
					'style' => 'style-3',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .social-RB-style-2 .tp-batch-top,{{WRAPPER}} .social-RB-style-2 .tp-batch-rating,
					{{WRAPPER}} .social-RB-style-2 .tp-batch-contant' => 'text-align: {{VALUE}}',
				],
				'default' => 'center',
				'toggle' => true,
				'label_widget' => false,
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .social-RB-style-1.tp-review .tp-batch-user,
								{{WRAPPER}} .social-RB-style-2.tp-review .tp-batch-user,
								{{WRAPPER}} .social-RB-style-3.tp-review .tp-batch-user',
				'conditions'   => [
					'terms' => [
						[
							'relation' => 'or',
							'terms'    => [
								[
									'name'     => 'RType','operator' => '==','value'    => 'beach',	
								],
								[
									'name'     => 'RType','operator' => '==','value'    => 'beach',	
									'name'     => 'Bstyle','operator' => '==','value'    => 'style-2',			
								],
							],
						],
					],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
					'{{WRAPPER}} .social-RB-style-1.tp-review .tp-batch-user,
								{{WRAPPER}} .social-RB-style-2.tp-review .tp-batch-user,
								{{WRAPPER}} .social-RB-style-3.tp-review .tp-batch-user' => 'color: {{VALUE}}',					
				],
				'conditions'   => [
					'terms' => [
						[
	...
	protected function render() {
	   ...
	   //layout
		...
		$output .= '<div id="'.esc_attr($uid_socirw).'" class="'.esc_attr($uid_socirw).' tp-social-reviews '.esc_attr($data_class).'" '.$layout_attr.' '.$data_attr.' data-enable-isotope="1"  data-scroll-normal="'.esc_attr($NormalScroll).'" data-textlimit="'.esc_attr($txtlimitData).'">';
		    ...
		    if($RType == "review"){
				$FinalData = [];
				$Perfo_transient = get_transient("SR-Performance-$WidgetUID");
				if( ($Performance == false) || ($Performance == true && $Perfo_transient === false) ){
					...
					set_transient("SR-Performance-$WidgetUID", $FinalData, $RefreshTime);
				}else {
					$FinalData = get_transient("SR-Performance-$WidgetUID");
				}
				...
				if(!empty($FinalData)){
					...
					if($postLodop == 'load_more' || $postLodop == 'lazy_load'){
						...
						if(get_transient("SR-LoadMore-$uid_socirw") === false){
							set_transient("SR-LoadMore-$uid_socirw", $remindata , $RefreshTime);
						}

						$postattr = [
							'load_class' => esc_attr($uid_socirw),
	...
	protected function Google_Reviews($RData){
	    ...
	    if($G_status == 200 && empty($Gdata['error_message'])){
			...
			$GG_Databash = get_option("elementor_google_review_{$PlaceName}");
			if ( !empty($GR) && (empty($GG_Databash) || $GG_Databash == false) ) {
				add_option( "elementor_google_review_{$PlaceName}", $GR, "", "yes" );
					...
					foreach ($GG_Databash as $i2 => $DataTwo){
						...
						if( $AuthorUrlOne != $AuthorUrlTwo ){
							if( !in_array( $AuthorUrlOne, $AarayTemp ) ){
								...
								update_option( "elementor_google_review_{$PlaceName}", $GG_Databash);
							}
						}
					}
				}
    ...
    protected function Review_Api($API){
		...
		$Final=$statuscode=[];
		if( empty($response) && curl_errno($curl) ){	
			$Final = array( "HTTP_CODE" => "400", "error" => array( "Message_Errorcurl" => curl_error($curl) ) );
		} else {
