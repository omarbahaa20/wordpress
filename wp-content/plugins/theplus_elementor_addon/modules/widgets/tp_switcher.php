					...
					$switcher .='<div class="switcher-toggle inactive '.esc_attr($switch_align).' '.esc_attr($switcher_style).'">';
						if($switcher_style=='style-1' || $switcher_style=='style-2' || $switcher_style=='style-3' || $switcher_style=='style-4'){					
							$switcher .='<div class="switch-1">
								<'.theplus_validate_html_tag($switcher_title_tag).' class="switch-label-text switch-label-1">'.esc_html($switch_a_title).'</'.theplus_validate_html_tag($switcher_title_tag).'>
							</div>';
							...
							$switcher .='<div class="switch-2">
								<'.theplus_validate_html_tag($switcher_title_tag).' class="switch-label-text switch-label-2">'.esc_html($switch_b_title).'</'.theplus_validate_html_tag($switcher_title_tag).'>
							</div>';
