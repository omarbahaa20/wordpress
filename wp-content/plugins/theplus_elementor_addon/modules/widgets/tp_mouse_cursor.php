...
class ThePlus_Mouse_Cursor extends Widget_Base {
    ...
    protected function _register_controls() {		
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'condition' => [					
					'mouse_cursor_type' => ['mouse-cursor-icon','mouse-follow-image'],
				],
				'conditions'   => [
					'terms' => [
						[
		...
		$this->add_control(
			...
			[
				...
				'default'      => 'no',	
				'condition' => [					
					'mouse_cursor_type' => ['mouse-cursor-icon','mouse-follow-image','mouse-follow-text'],
				],
				'conditions'   => [
					'terms' => [
						[
    ...
    protected function render() {
    	...
    	if ($settings['cursor_effect'] =='mc-column' || $settings['cursor_effect'] =='mc-section' || $settings['cursor_effect'] =='mc-widget' || $settings['cursor_effect'] =='mc-body') {
