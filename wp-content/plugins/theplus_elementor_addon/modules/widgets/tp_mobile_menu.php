...
class ThePlus_Mobile_Menu extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_responsive_control(
            ...
            [
				...
				'render_type' => 'ui',
				'selectors' => [
					'{{WRAPPER}} .tp-mobile-menu .tp-mm-li i,{{WRAPPER}} .tp-mm-c-wrapper .tp-menu-link i,{{WRAPPER}} .tp-mm-et-wrapper .tp-mm-et-li i' => 'font-size: {{SIZE}}{{UNIT}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tp-mobile-menu .tp-mm-li i,{{WRAPPER}} .tp-mm-c-wrapper .tp-menu-link i,{{WRAPPER}} .tp-mm-et-wrapper .tp-mm-et-li i' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tp-mobile-menu .tp-mm-li.active i,{{WRAPPER}} .tp-mm-c-wrapper .tp-menu-link i,{{WRAPPER}} .tp-mm-et-wrapper .tp-mm-et-li i' => 'color: {{VALUE}};',
		...
		$this->add_responsive_control(
            ...
            [
				...
				'render_type' => 'ui',
				'selectors' => [
					'{{WRAPPER}} .tp-mm-c-wrapper .tp-menu-link i,{{WRAPPER}} .tp-mm-et-wrapper .tp-mm-et-li i' => 'font-size: {{SIZE}}{{UNIT}}',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tp-mm-c-wrapper .tp-menu-link i,{{WRAPPER}} .tp-mm-et-wrapper .tp-mm-et-li i' => 'color: {{VALUE}};',
    ...
    protected function render() {
		...
		if(!empty($settings['open_mobile_menu']['size'])){
			...
			$css_rule .='@media (min-width:'.esc_attr($close_mobile_menu).'){.tp-mobile-menu.'.esc_attr($uid).'{display:none;}}';
