    ...
    protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tp-woo-single-pricing .variations_form.cart .variations td.label',
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tp-woo-single-pricing .variations_form.cart .variations td.label' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_control(
					...
					if(!empty($select) && $select=="price"){ 
						...
						<div class="tp-woo-single-pricing">
							<div class="tp-woo-price"> 
								<?php if(!empty($dis_before_price)){ ?><span class="tp-woo-price-text"><?php echo esc_html__($dis_before_price, 'theplus' ); ?></span><?php } ?> 
									<?php woocommerce_template_single_price(); ?>
								<?php if(!empty($dis_after_price)){ ?><span class="tp-woo-price-text"><?php echo esc_html__($dis_after_price, 'theplus' ); ?></span><?php } ?>
							</div>
						</div>
						<?php		
					}
