...
class ThePlus_Coupon_Code extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
            'hideLink',
            [
				'label' => esc_html__( 'Hide Link (Beta)', 'theplus' ),
	 ...
	 protected function render() {
		...
		$iduu=get_the_ID();
		if(!empty($tabReverse) && $tabReverse=='yes' && !empty($copLoop) && $copLoop=='yes'){				
					...
					$output .= '<div class="coupon-front-inner">';
						...
						if($frontContentType == 'default' && !empty($frontContent)) {
							$output .= '<div class="coupon-inner-content">';
								$output .= '<h3 class="coupon-front-content">'.$frontContent.'</h3>';
							$output .= '</div>';
					...
					$output .= '<div class="coupon-back-inner">';
						if($backContentType == 'default') {
							$output .= '<div class="coupon-back-content">';
								if(!empty($backTitle)) {
									$output .= '<h3 class="coupon-back-title">'.esc_html($backTitle).'</h3>';
								}
								if(!empty($backDesc)) {
